...
export function UserManagement() {
  ...
  const managerUsers = users.filter(u => u.role === 'user') // Treating regular users as "managers"
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <input 
              ...
              className="bg-neutral-800 border border-neutral-700 rounded-lg px-4 py-2 pl-10 text-sm text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-blue-500 w-80"
            />
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Select value={newUserData.role} onValueChange={(value: 'admin' | 'user') => setNewUserData({ ...newUserData, role: value })}>
                  <SelectTrigger>
                      ...
                      <td className="py-4 px-6 text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="bg-neutral-800 border-neutral-700">
                            ...
                            {user.role !== 'user' && (
                              <DropdownMenuItem onClick={() => updateUserRole(user.id, 'user')} className="text-neutral-300 hover:text-white">
